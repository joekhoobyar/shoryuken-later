      ...
      module ClassMethods
        ...
        def perform_later(time, body, options = {})
          ...
          # Otherwise, the message is inserted into a DynamoDB table with the same name as the queue.
            ...
            queue = get_shoryuken_options['queue']
            msg = JSON.dump(body: body, options: options)
            Shoryuken::Later::Client.put_item(queue, perform_at: time.to_i, shoryuken_message: msg,
